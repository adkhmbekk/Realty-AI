...
def search_apartments(
    ...
    deal_type: Optional[str] = Query(None, description="Тип сделки: sale (продажа) / rent (аренда). Пусто — все."),
    ...
    land_area_min: Optional[float] = Query(None, description="Соток от (для участков)."),
    land_area_max: Optional[float] = Query(None, description="Соток до (для участков)."),
